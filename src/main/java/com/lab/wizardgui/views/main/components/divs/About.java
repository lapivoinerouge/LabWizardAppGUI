...
public class About extends Div {
    ...
    public About() {
        ...
        Paragraph p1 = new Paragraph("Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor " +
        ...
        Paragraph p2 = new Paragraph("Augue ut lectus arcu bibendum at varius vel. Eu tincidunt tortor aliquam nulla facilisi. Nunc mattis" +
